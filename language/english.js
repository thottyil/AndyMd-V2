...
👨‍❤️‍👨 𝙨𝙩𝙖𝙩𝙪𝙨: ${pasangan ? `Berpacaran @${pasangan.split`@`[0]}` : '-' }
#️⃣ 𝙣𝙤𝙢𝙤𝙧: ${PhoneNumber('+' + m.sender.replace('@s.whatsapp.net', '')).getNumber('international')}
🔗 𝙡𝙞𝙣𝙠: https://wa.me/${m.sender.split`@`[0]}
🤷‍♂️ 𝙭𝙥: Total ${exp} (${exp - min} / ${xp}) [ ${math <= 0 ? `Ready to *${prefix}levelup*` : `${math} XP left to levelup`} ]
🎚️ 𝙡𝙚𝙫𝙚𝙡: ${level}
🎢 𝙧𝙤𝙡𝙚: ${role}
📊 𝙡𝙞𝙢𝙞𝙩: ${limit}
®️ 𝙧𝙚𝙜𝙞𝙨𝙩𝙚𝙧𝙚𝙙: ${registered ? '✅ (' + tanggal(regTime) + ')' : '❌'}
...
exports.firstChat = (a, b, c) =>{
	return`𝙨𝙖𝙠 𝙜𝙚𝙣𝙡𝙖 ${a} ${b} 🤗, 𝙢𝙚 𝙘 ${c} 𝙢𝙚 𝙨𝙚 𝙮𝙤𝙣 𝙧𝙤𝙗𝙤𝙩 𝙬𝙝𝙖𝙩𝙨𝙖𝙥𝙥. 𝙠𝙞𝙟𝙖𝙣𝙬 𝙢𝙥 𝙠𝙖𝙥 𝙚𝙙𝙚𝙬 𝙨𝙫𝙥 😎 ${c} ?`
	}
exports.StartAbsen = () =>{
	return`Mulai Absen`
	}
...
1. Ne spammez pas les robots. ️
2. N'appelez pas les robots. ️
3. Ne comparez pas les bots 👍

🗯️ Bot pas ou lent à répondre?
️ Peut être affecté par le réseau, le signal, interdit par Whatsapp et certains aléatoires.

🗯️ Ki kote mwen ka jwenn script la nan bot sa a?
️ Ou ka jwenn script sa a sou YouTube andyOfc

🗯️ Èske mwen ka ajoute nan gwoup la?
️ Pou sa li depann de mèt bot la li menm

🗯️ Ki prefiks la?
️ Bot sa a sèvi ak plizyè prefiks epi ou ka itilize li san prefiks

Si w konprann règ yo, tanpri tape *${prefix}menu* Komanse!

⚠️ Tout règleman ak kondisyon bot yo sijè a chanje nenpòt ki lè 
...
Recode : https://youtube.com/andyOfc
`
}
...
Bonjou sè ️
Ou ka sipòte m pou kenbe bot sa a ajou lè w fè yon don

Nenpòt montan nan don ou pral vle di anpil 👍
Pou moun nan nou ki fè don, ou ka voye prèv
bay pwopriyetè a
